namespace SunriseTests.ElementsContext 
{
	internal class FinderContextBase
	{
		...
		/// <summary>
		///Первая линия таблицы на странице "Управление освещением" (для фокусировки)
		/// </summary>
		public const string LightCtrlFocusLine = nameof(LightCtrlFocusLine);
		/// <summary>
		///Кнопка "Выделить все" на странице "Управление освещением"
		/// </summary>
		public const string LightCtrlSelectAll = nameof(LightCtrlSelectAll);
